...
export function renderTestimonials() {
  ...
  return `<section class="testimonials" id="voices" aria-labelledby="voices-title" aria-roledescription="carousel"><div class="testimonials-heading"><p class="section-index">From the people who were there</p><h2 id="voices-title">In good company.</h2><div class="testimonial-progress" aria-hidden="true" hidden><span></span></div></div><div class="testimonial-track" id="testimonial-track" tabindex="0" aria-label="Community testimonials">${quotes.map(render).join("")}</div></section>`;
}
